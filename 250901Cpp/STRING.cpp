    ...
    : id{ ++gid }
{
    ...
    //관찰메시지
    if (관찰)
        println("[{:5}] 복사생성자    - 내주소:{:014} , 글자수:{:3},  글자주소:{:014}", id, (void*)this, len, (void*)p);
}
...
STRING& STRING::operator=(const STRING& other)
{
    ...
    //관찰메시지
    if (관찰)
        println("[{:5}] 복사할당      - 내주소:{:014} , 글자수:{:3},  글자주소:{:014}", id, (void*)this, len, (void*)p);
    ...
    : id{ ++gid }
{
    ...
    //관찰메시지
    if (관찰)
        println("[{:5}] 이동생성      - 내주소:{:014} , 글자수:{:3},  글자주소:{:014}", id, (void*)this, len, (void*)p);
...
STRING& STRING::operator=(STRING&& other)
{
    ...
    //관찰메시지
    if (관찰)
        println("[{:5}] 이동할당      - 내주소:{:014} , 글자수:{:3},  글자주소:{:014}", id, (void*)this, len, (void*)p);
}
...
//2025.11.17
// //전역연산자 오버로딩 함수는 클래스에서 friend로 선언한다.

STRING operator+(const char* s, const STRING& rhs)
{
    STRING temp;
    unsigned len = strlen(s);
    temp.len = len + rhs.len;                //  = s + rhs
